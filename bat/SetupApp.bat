...
:: Android packaging
set AND_CERT_NAME="starling-builder-editor"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\starling-builder-editor.p12
...
set IOS_PROVISION=cert\starling-builder-editor.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=starling-builder-editor
